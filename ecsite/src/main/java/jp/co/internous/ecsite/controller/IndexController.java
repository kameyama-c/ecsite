...
@Controller
//RequestMappingアノテーションによりlocalhost:8080/ecsite/ のURLで アクセスできるよう設定
...
public class IndexController {
	...
	//トップページ(index.html)に推移するメソッド
	//goodsテーブルから取得した商品エンティティ一覧をフロントに渡すModelに追加
	@RequestMapping("/")
	...
	//その後、DTOをゲストの情報で初期 化し、検索結果があれば実在のユーザ情報をDTOに詰める 
	//最終的に、DTOをJSONオブジェクト として画面側に返す
	@ResponseBody
